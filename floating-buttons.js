...
(function () {
    ...
    const POKER_AD_STORAGE_KEY = 'lumenpedia_poker_ad_minimized';
    ...
    <div class="floating-ad-wrap" id="floating-poker-ad">
        <a href="${POKER_URL}" class="floating-ad-btn" target="_blank" rel="noopener noreferrer" aria-label="Visit Basement Poker">
            ...
            <span class="floating-ad-copy">
                ...
                <span class="floating-ad-title">Play Basement Poker</span>
            </span>
        </a>
        <button type="button" class="floating-ad-toggle" aria-label="Minimize poker ad" aria-expanded="true">
            ${minimizeIcon}
        </button>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function setPokerAdMinimized(minimized) {
            ...
            toggleButton.setAttribute('aria-label', minimized ? 'Expand poker ad' : 'Minimize poker ad');
